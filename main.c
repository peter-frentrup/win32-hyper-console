...
static wchar_t *read_input(BOOL multiline_mode);
...
static void print_error() {
  ...
  wprintf(L"error %x: %s", (unsigned)dw, msgbuf);
...
int main() {
  ...
  printf("Finish with 'quit'. Switch to multi-line mode with 'multi' and back wih 'single'\n");
